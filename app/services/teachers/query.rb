module Teachers
  ...
  private
    ...
    def where_appropriate_body_is(appropriate_body)
      ...
      return @scope = Teacher.none if appropriate_body.nil?

      @scope = AppropriateBodies::CurrentTeachers.new(appropriate_body).current
    end
    ...
    def where_appropriate_body_ids_in(appropriate_body_ids)
      ...
      @scope = Admin::CurrentTeachers.new(appropriate_body_ids).current
    end
